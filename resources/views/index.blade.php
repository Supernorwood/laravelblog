                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="{{ route('category.single', ['id' => $third_post->category->id]) }}">{{ $second_post->category->name }}</a>
                                        </span>
                ...
                <div class="col-lg-12">
                                        ...
                                        <div class="case-item">
                                            <div class="case-item__thumb">
                                                ...
                                                <a href="{{ route('post.single', ['slug' => $post->slug]) }}">
                                                    <img src="{{ $post->featured }}" alt="our case"></a>
                                            </div>
                    ...
                    {{--<div class="offers">
                        <div class="row">
                            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                <div class="heading">
                                    <h4 class="h1 heading-title">deep work</h4>
                                    <div class="heading-line">
                                        <span class="short-line"></span>
                                        <span class="long-line"></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="case-item-wrap">
                                ...
                                @foreach($deepwork->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
